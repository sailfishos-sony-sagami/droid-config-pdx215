= SAILFISH X FOR SONY XPERIA™ 1 III FLASHING GUIDE =

= FOR LINUX, WINDOWS AND OS X =

= STEP 1: GETTING AN XPERIA™ 1 III =

Get an Xperia™ 1 III. To be able to replace the Sony Android
...
The best way to get an unlockable device is to buy is a brand new Xperia™ 1 III
...
website and select the model of your device Xperia™ 1 III.
